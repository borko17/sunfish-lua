...
| `l`           | Load a saved game                                           |
| `nN`          | Change engine strength in the range of 100-50000 (e.g. 'n4000'). Higher N = harder/slower; lower N = easier/faster. |
| `r`           | Resign                                                      |
| `n`           | Start a new game                                            |
...
- A monospaced font is recommended for board alignment; for Unicode piece mode, a font with good chess-symbol coverage ([DejaVu Sans Mono](https://github.com/dejavu-fonts/dejavu-fonts/releases), [Julia Mono](https://github.com/cormullion/juliamono/releases), [Everson Mono](https://www.evertype.com/emono/), or [Unifont](https://github.com/multitheftauto/unifont/releases)) is recommended.
