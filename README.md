...
This project is a derivative work of the original Sunfish engine and is distributed under the same [GNU GPL v3](https://www.gnu.org/licenses/gpl-3.0.en.html) license (see [`LICENSE`](./LICENSE)).
